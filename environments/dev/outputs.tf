...
output "alb_info" {
  ...
  value = {
    ...
    url_http         = "http://${module.alb.lb_dns_name}"
    url_https        = var.ssl_certificate_arn != null ? "https://${module.alb.lb_dns_name}" : "SSL certificate not configured"
  }
}
...
output "cluster_summary" {
  ...
  value = {
    ...
    alb_endpoint       = module.alb.lb_dns_name
